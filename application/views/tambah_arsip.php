            ...
            <div class="panel-body container-fluid" style="padding: 0px 350px">
              <form autocomplete="off">
                ...
                <div >
                  ...
                  <input type="text" class="form-control" id="inputPlaceholder" placeholder="Nomor Surat">
                  <br>
                </div>

                <div>
                  <h4 class="example-title">Judul</h4>
                  <input type="text" class="form-control" id="inputPlaceholder" placeholder="Judul Surat">
                  <br>
                </div>
