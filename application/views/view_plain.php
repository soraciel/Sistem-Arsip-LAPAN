...
<body>
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail margin-0" href="javascript:void(0)">
                            <img class="width-full" src="<?php echo base_url();?>/assets/photos/placeholder.png" alt="..." />
                          </a>
                        </li>
                        <li>
                          <a class="thumbnail margin-0" href="javascript:void(0)">
  ...
  <div class="page animsition">
    ...
    <div class="page-content container-fluid">
          ...
          <div class="row row-lg">
            <div class="col-sm-6">
              ...
              <div class="example-wrap">
                <h4 class="example-title">Pills</h4>
                <div class="example">
                  <ul class="nav nav-pills">
                    ...
                    <li class="disabled" role="presentation"><a href="javascript:void(0)">Messages</a></li>
                  </ul>
                </div>
              </div>
              <!-- End Example Pills -->
            ...
            <div class="col-sm-6">
              <!-- Example Iconified Pills -->
              <div class="example-wrap">
                <h4 class="example-title">Iconified Pills</h4>
                <div class="example">
                  <ul class="nav nav-pills">
                    <li class="active" role="presentation"><a href="javascript:void(0)"><i class="icon wb-home" aria-hidden="true"></i> Home</a></li>
                    <li role="presentation"><a href="javascript:void(0)"><i class="icon wb-user" aria-hidden="true"></i> Profile</a></li>
                    <li class="disabled" role="presentation"><a href="javascript:void(0)"><i class="icon wb-chat" aria-hidden="true"></i> Messages</a></li>
                  </ul>
                </div>
              </div>
              <!-- End Example Iconified Pills -->
            </div>

            <div class="col-sm-6">
              <!-- Example Pills -->
              <div class="example-wrap margin-sm-0">
                <h4 class="example-title">Stacked Pills</h4>
                <div class="example">
              ...
              <!-- End Example Stacked Pills -->
            </div>


            <div class="col-sm-6">
              <!-- Example Pills With Dropdowns -->
              <div class="example-wrap">
                <h4 class="example-title">Pills With Dropdowns</h4>
                <div class="example">
                  <ul class="nav nav-pills">
                    <li class="active" role="presentation"><a href="javascript:void(0)"><i class="icon wb-home" aria-hidden="true"></i> Home</a></li>
                    <li role="presentation"><a href="javascript:void(0)"><i class="icon wb-help-circle" aria-hidden="true"></i> Help</a></li>
                    <li class="dropdown" role="presentation">
                      <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"
                      role="button">
                        <i class="icon wb-wrench" aria-hidden="true"></i> Dropdown
              ...
              <!-- End Example Pills With Dropdowns -->
            </div>
        ...
        <div class="panel-body">
          <div class="row row-lg">
            ...
            <div class="col-lg-6">
              <!-- Example Nav Tabs -->
              <div class="example-wrap">
                <h4 class="example-title">Nav Tabs</h4>
                <div class="example">
            ...
            <div class="col-lg-6">
              ...
              <!-- End Example Nav Tabs Line -->
            </div>

            <div class="col-lg-6">
              <!-- Example Nav Tabs Vertical -->
              <div class="example-wrap margin-lg-0">
                <h4 class="example-title">Nav Tabs Vertical</h4>
                <div class="example">
              ...
              <!-- End Example Nav Tabs Vertical -->
            </div>

            <div class="col-lg-6">
              <!-- Example Nav Tabs Line Vertical -->
              <div class="example-wrap">
                <h4 class="example-title">Nav Tabs Line Vertical</h4>
                <div class="example">
                  <div class="nav-tabs-vertical">
                    <ul class="nav nav-tabs nav-tabs-line">
                      <li class="active"><a data-toggle="tab" href="javascript:void(0)">Home</a></li>
              ...
              <!-- End Example Nav Tabs Line Vertical -->
            </div>
      ...
      <!-- Quick Menu -->
      <div class="example-wrap">
        <h4 class="example-title">Quick Menu</h4>
        ...
        <!-- End Example Quick Menu -->
        <!-- Example Quick Menu Large -->
        <div class="example">
        ...
        <!-- End Example Quick Menu Large -->

        <!-- Example Quick Menu Bordered -->
        <div class="example">
        ...
        <!-- End Example Quick Menu Bordered -->
      </div>
      <!-- End Quick Menu -->
    </div>
  </div>
